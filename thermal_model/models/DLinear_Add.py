...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Merge Layer
        self.Linear_Merge = nn.Linear(2,1)
        self.Linear_Merge1 = nn.Linear(2,10)
        self.sigm = nn.Sigmoid()
        self.Linear_Merge2 = nn.Linear(10,1)
    ...
    def forward(self, x):
        ...
        # print(x.shape, x_m1sum_future.shape)
        # x_concat = torch.cat((x, x_m1sum_future), dim=2)

        # x = self.Linear_Merge(x_concat)
