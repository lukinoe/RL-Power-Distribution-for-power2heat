...
model.model.load_state_dict(torch.load(script_dir + "/checkpoints/model_" + str(seq_len)))
...
_states, _actions, _reward_sum = model.predict(day)
plot_states(_states[:,-1], _actions, args["optimum_storage"], id=day)
