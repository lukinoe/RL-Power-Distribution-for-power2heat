...
class Dataset_Custom_Merge(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='indv_house.csv',
    ...
    def __getitem__(self, index):
        ...
        seq_x = np.concatenate((seq_x_future, seq_x), axis=1)
...
class Dataset_Custom_Merge_Multivariable(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='indv_house.csv',
                 target='value', scale=False, timeenc=0, freq='h'):
        # size [seq_len, label_len, pred_len]
...
class Dataset_Custom_Future_Seq(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='indv_house.csv',
                 target='value', scale=True, timeenc=0, freq='h'):
        # size [seq_len, label_len, pred_len]
    ...
    def __getitem__(self, index):
        ...
        # seq_x_future = self.data_x[r_begin:r_end,0]
        # print(seq_x.shape, seq_x_future.shape)
        # seq_x_future = np.append(seq_x_future, np.zeros(seq_x.shape[0] - self.pred_len))  # zero pad to seq_x shape
        # if seq_x_future.shape[0] > seq_x.shape[0]:
        #     seq_x_future = seq_x_future[:seq_x.shape[0]]  

        # seq_x_future = seq_x_future.reshape((seq_x.shape[0], 1))

        seq_x_future = self.data_x[r_end-seq_x.shape[0]:r_end,0]
        # print(seq_x.shape, seq_x_future.shape)
        # seq_x_future = np.append(seq_x_future, np.zeros(seq_x.shape[0] - self.pred_len))  # zero pad to seq_x shape
        # if seq_x_future.shape[0] > seq_x.shape[0]:
        #     seq_x_future = seq_x_future[:seq_x.shape[0]]  
        ...
        #print(seq_x_future.shape, seq_x.shape)
